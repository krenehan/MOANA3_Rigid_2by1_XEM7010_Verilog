...
module ddr3 (
	...
	// MT41K256M16TW-125 is the part number for the RAM on the XEM7010
	// Density 4096Mbits (512 MBytes)
	// Organization is 256Mb x 16
	
	
	
	// Parameters below are pulled from the `define sg125 section of the 4096Mb_ddr3_parameters.vh file. 
	// Opal Kelly lists the speed grade as 125 when generating the memory interface, which is why I went with sg125. 
	// However, it looked to me like all MT41K256M16TW parts (which is what the product page says the XEM7010 uses) have 107 speed grade.
	...
	// These settings come from organization x16, speed grade 125 of the 4096Mb_ddr3_parameters.vh file
	...
	// Size parameters selected for x16 organization
    ...
    // Size Parameters (not dependent on organization)
	...
	// Selected for single rank (not multi chip module)
	...
	// Function selected based on 125 speed grade
